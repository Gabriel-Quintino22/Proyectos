...
import pandas as pd                     #smf: es para trabajar modelos de regresion
import statsmodels.formula.api as smf   #sickitlearn:  es para machine learning
                                        #Minuto 10 del video es importante*

# Leemos los datos
datos = pd.read_excel("/content/Datos_Modelo.xlsx", sheet_name="Datos")  #Con pandas = 
#pd llamamos a la funcion read_excel
...
#Vamos a sobre escribir datos tamaño empresa
...
# Modelos de ML: regresión lineal, arbol de decision, random forest y knn
...
#Como vi en R en los modelos de machine learning esta dividido en partes
#las variables x (independientes); Experiencia, años_educacion, tamaño_empresa_certificaciones
#y una variable dependendiente, y; salario, para las variables x tenemos
#entrenamiento y testeo. Para y tenemos entrenamiento y testeo.
#Por ende las variables x: Experiencia, años_educacion, tamaño de empresa
#Por ende la variable y: salario


# Leemos el archivo Excel
datos = pd.read_excel("/content/Datos_Modelo.xlsx", sheet_name="Datos")
datos.head()
#DATO IMPORTANTE*: cuando trabajamos con Python y queremos seleccionar variables(plural)
#a un vector se le asigna a un vector en mayuscula por ejemplo: X, mientras que si 
#en una variable que se le quiere asignar un vector le colocamos en minuscula: y.
